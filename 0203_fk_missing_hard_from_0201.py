    ...
    for epoch in range(args.epochs):
        if epoch % args.log_every == 0:
            ...
            if fk_count_list:
                ...
                print(
                    f"  eval fk_top1={avg_top1:.4f} fk_recall@{args.fk_topk}={avg_rec:.4f} "
        ...
        for table_name, table_meta in all_table_meta.items():
            ...
            loss = huber(pred_train, train_labels) + args.fk_match_weight * loss_match
            loss.backward()
            optimizer.step()
