...
def apply_fk_hard_propagation(
    ...
    # Normalize row_fk to reduce scale mismatch across tables.
...
def main():
    ...
    parser.add_argument("--mask_fk", type=int, default=0)
    ...
    for table_name, table in tables.items():
        ...
        data = get_data_from_table(values, args.missing_ratio, args.missing_mechanism, args.seed, mask_cols)
